...
* Open a command prompt and execute:
    ...
    ruby dk.rb init
    ruby dk.rb install
* Change to the directory containing the gem download and execute the following
    gem install socialcast-git-extensions-3.1.2.gem
...
* Connect to the Perigee SocialNet community by executing the following command
    socialcast authenticate --domain perigeeglobal-com.socialcast.com
